...
Set objFileToRead = CreateObject("Scripting.FileSystemObject").OpenTextFile("F:\Commands\mapcount.txt",1)
Dim strLine
...
Set objFileToWrite = CreateObject("Scripting.FileSystemObject").OpenTextFile("F:\Commands\mapcount.txt",2,true)
